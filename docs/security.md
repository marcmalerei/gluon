...
This threat model applies to the supported `1.0.2` release line. Its
...
| Trusted Types | Unsafe sinks are visible in public API names. No `1.0.2` enforcement compatibility claim is made. | An enforcing application must own and audit a compatible policy until Gluon defines a public policy contract. | `src/runtime.ts`, `docs/dom-runtime.md` |
