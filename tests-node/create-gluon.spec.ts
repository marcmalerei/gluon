...
describe('create-gluon scaffolding', () => {
  test('writes the minimal public-boundary starter', async () => {
    ...
    expect(manifest.dependencies).toEqual({ '@gluonjs/core': '1.12.3' });
  ...
  test('writes the universal testing and UI surfaces', async () => {
    ...
    expect(manifest.dependencies).toMatchObject({
      '@gluonjs/core': '1.12.3',
      '@gluonjs/atoms': '1.12.3',
      '@gluonjs/router': '1.12.3',
      '@gluonjs/reactivity': '1.12.3',
      '@gluonjs/store': '1.12.3',
      '@gluonjs/ssr': '1.12.3',
    });
