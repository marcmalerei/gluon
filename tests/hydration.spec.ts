...
describe('SSR hydration', () => {
  ...
  it('hands component carriers to their exact renderer-owned sheets and diagnoses mismatches', async () => {
    ...
    expect(styleRoot.adoptedStyleSheets).toContain(navigationMenuStyles);
    expect(styleRoot.adoptedStyleSheets).toContain(oneTimePasswordFieldStyles);
