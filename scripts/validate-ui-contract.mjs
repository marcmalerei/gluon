...
const expected = new Map([
  ...
  ['@gluonjs/molecules', ['Accordion', 'ButtonGroup', 'Card', 'ChoiceGroup', 'ControlField', 'DialogSurface', 'Disclosure', 'FormField', 'InlineNotice', 'NavigationStrip', 'SegmentedControl', 'Tabs']],
...
try {
  ...
  for (const marker of ['gluon-checkbox', 'gluon-progress', 'gluon-radio', 'gluon-status-badge', 'gluon-switch', 'gluon-toggle-button', 'gluon-input', 'gluon-label', 'gluon-icon', 'gluon-select', 'gluon-textarea', 'gluon-accordion', 'gluon-button-group', 'gluon-card', 'gluon-choice-group', 'gluon-control-field', 'gluon-dialog-surface', 'gluon-disclosure', 'gluon-form-field', 'gluon-inline-notice', 'gluon-navigation-strip', 'gluon-segmented-control', 'gluon-tabs', 'gluon-app-shell']) {
