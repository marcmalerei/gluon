...
const expected = new Map([
  ...
  ['@gluonjs/molecules', ['Accordion', 'ButtonGroup', 'Card', 'ChoiceGroup', 'ControlField', 'DialogSurface', 'Disclosure', 'ResponsiveDisclosure', 'EmptyState', 'FormField', 'InlineNotice', 'Toast', 'ToastViewport', 'NavigationStrip', 'NavigationMenu', 'ResponsiveActionBar', 'DropdownMenu', 'ContextMenu', 'Menubar', 'Toolbar', 'SegmentedControl', 'TableRegion', 'Tabs', 'SearchField', 'SearchResults', 'OneTimePasswordField', 'PasswordToggleField']],
...
try {
  ...
  for (const marker of ['gluon-card', 'gluon-form-field', 'gluon-navigation-strip', 'gluon-app-shell']) {
...
try {
  ...
  for (const marker of ['gluon-aspect-ratio', 'gluon-avatar', 'gluon-checkbox', 'gluon-progress', 'gluon-radio', 'gluon-scroll-area', 'gluon-separator', 'gluon-slider', 'gluon-status-badge', 'gluon-switch', 'gluon-toggle-button', 'gluon-input', 'gluon-label', 'gluon-icon', 'gluon-select', 'gluon-textarea', 'gluon-accordion', 'gluon-button-group', 'gluon-card', 'gluon-choice-group', 'gluon-control-field', 'gluon-dialog-surface', 'gluon-empty-state', 'gluon-form-field', 'gluon-inline-notice', 'gluon-navigation-strip', 'gluon-segmented-control', 'gluon-tabs', 'gluon-app-shell', 'gluon-confirmation-dialog']) {
...
console.log(`UI contract valid: 4 optional packages, 30 typed extension entries, canonical DX T2 extensions, exact production component chunks exclude unrelated UI markers, GLUON GOODS ${JSON.stringify(shopComposition)}`);
