...
const expected = new Map([
  ...
  ['@gluonjs/molecules', ['ButtonGroup', 'Card', 'ChoiceGroup', 'ControlField', 'FormField', 'NavigationStrip', 'SegmentedControl']],
...
console.log(`UI contract valid: 4 optional packages, 25 typed extension entries, canonical DX T2 extensions, exact production component chunks exclude unrelated UI markers, GLUON GOODS ${JSON.stringify(shopComposition)}`);
