...
const expected = new Map([
  ...
  ['@gluonjs/atoms', ['Button', 'Checkbox', 'Icon', 'Input', 'Label', 'Radio', 'Select', 'Switch', 'Textarea', 'ToggleButton', 'installUi']],
...
try {
  ...
  for (const marker of ['gluon-checkbox', 'gluon-radio', 'gluon-switch', 'gluon-toggle-button', 'gluon-input', 'gluon-label', 'gluon-icon', 'gluon-select', 'gluon-textarea', 'gluon-card', 'gluon-form-field', 'gluon-navigation-strip', 'gluon-app-shell']) {
...
console.log(`UI contract valid: 4 optional packages, 19 typed extension entries, canonical DX T2 extensions, exact production component chunks exclude unrelated UI markers, GLUON GOODS ${JSON.stringify(shopComposition)}`);
