...
const expected = new Map([
  ...
  ['@gluonjs/molecules', ['Accordion', 'ButtonGroup', 'Card', 'ChoiceGroup', 'ControlField', 'DialogSurface', 'Disclosure', 'ResponsiveDisclosure', 'EmptyState', 'FormField', 'InlineNotice', 'NavigationStrip', 'SegmentedControl', 'TableRegion', 'Tabs', 'SearchField', 'SearchResults']],
