...
const expected = new Map([
  ...
  ['@gluonjs/molecules', ['ButtonGroup', 'Card', 'ChoiceGroup', 'ControlField', 'DialogSurface', 'FormField', 'NavigationStrip', 'SegmentedControl', 'Tabs']],
