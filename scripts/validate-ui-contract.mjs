...
const expected = new Map([
  ...
  ['@gluonjs/atoms', ['Button', 'Checkbox', 'Icon', 'Input', 'Label', 'Progress', 'Radio', 'Select', 'Slider', 'StatusBadge', 'Switch', 'Textarea', 'ToggleButton', 'installUi']],
...
try {
  ...
  for (const marker of ['gluon-checkbox', 'gluon-progress', 'gluon-radio', 'gluon-slider', 'gluon-status-badge', 'gluon-switch', 'gluon-toggle-button', 'gluon-input', 'gluon-label', 'gluon-icon', 'gluon-select', 'gluon-textarea', 'gluon-accordion', 'gluon-button-group', 'gluon-card', 'gluon-choice-group', 'gluon-control-field', 'gluon-dialog-surface', 'gluon-disclosure', 'gluon-empty-state', 'gluon-form-field', 'gluon-inline-notice', 'gluon-navigation-strip', 'gluon-segmented-control', 'gluon-tabs', 'gluon-app-shell']) {
...
console.log(`UI contract valid: 4 optional packages, 26 typed extension entries, canonical DX T2 extensions, exact production component chunks exclude unrelated UI markers, GLUON GOODS ${JSON.stringify(shopComposition)}`);
