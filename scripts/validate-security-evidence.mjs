...
const requiredAreas = ['html', 'urls', 'styles', 'ssr-state', 'csp', 'trusted-types', 'eleventy-prerendering', 'gluon-project-analysis', 'vue-source-analysis', 'component-generation'];
...
if (model.releaseLine !== '1.0.10') throw new Error('security threat model releaseLine must match 1.0.10');
