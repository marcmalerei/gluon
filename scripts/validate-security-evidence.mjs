...
const requiredAreas = ['html', 'urls', 'styles', 'ssr-state', 'csp', 'trusted-types', 'vue-source-analysis'];
...
if (model.releaseLine !== '0.0.0') throw new Error('security threat model releaseLine must match 0.0.0');
