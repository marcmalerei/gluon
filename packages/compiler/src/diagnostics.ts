...
const definitions = [
  ...
  entry(1409, 'GLUON_API_MANIFEST', 'API manifest contract failed', 'The public API manifest is missing, malformed, or inconsistent with the shipped package surface.', 'Machine-readable tooling cannot safely validate or consume the public API contract.', 'Regenerate the manifest and run the package, type, and manifest checks before publishing.', 'tooling'),
