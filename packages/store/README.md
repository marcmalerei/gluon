...
The package ships as part of the current `1.12.1` release line.
...
**Public API:** [`@gluonjs/store`](https://marcmalerei.github.io/gluon/1.12.1/api/generated/packages/store/src/)
