...
The package ships as part of the current `1.13.0` release line. Core and
...
**Public API:** [`@gluonjs/router`](https://marcmalerei.github.io/gluon/1.13.0/api/generated/packages/router/src/) · [`@gluonjs/router/memory`](https://marcmalerei.github.io/gluon/1.13.0/api/generated/packages/router/src/memory/)
