...
The package ships as part of the current `1.12.3` release line. Core and
...
**Public API:** [`@gluonjs/router`](https://marcmalerei.github.io/gluon/1.12.3/api/generated/packages/router/src/) · [`@gluonjs/router/memory`](https://marcmalerei.github.io/gluon/1.12.3/api/generated/packages/router/src/memory/)
