...
- Updated generated applications and components to pin the complete selected
  Gluon package set to the lockstep `1.4.0` release.

## [1.3.0] - 2026-07-23

### Changed

- Updated generated applications to pin the complete official Gluon package
  selection to the lockstep 1.3.0 release.

## [1.2.0] - 2026-07-21

### Changed

- Generated applications and components now pin the complete selected Gluon
  package set to lockstep version `1.2.0`.
