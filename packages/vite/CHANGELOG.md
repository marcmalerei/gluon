...
- Advanced the lockstep tooling release for the bundled language-server and
  editor distribution contracts.

## [1.9.0] - 2026-08-15

### Changed

- Advanced the lockstep release with the documented Devtools capability
  handshake and VS Code distribution contract.
