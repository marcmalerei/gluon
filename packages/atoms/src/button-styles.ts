...
export const buttonStyles = css`
  @layer atoms {
    ...
    :where(.gluon-button.is-primary) { background: var(--gluon-button-background, var(--gluon-color-action, #087f7b)); border-color: var(--gluon-button-border-color, transparent); color: var(--gluon-button-color, var(--gluon-color-action-text, white)); }
    :where(.gluon-button.is-secondary) { background: var(--gluon-button-background, var(--gluon-color-action-soft, #e6f4f1)); border-color: var(--gluon-button-border-color, transparent); color: var(--gluon-button-color, var(--gluon-color-action-soft-text, #075e5b)); }
    :where(.gluon-button.is-ghost) { background: var(--gluon-button-background, transparent); border-color: var(--gluon-button-border-color, currentcolor); color: var(--gluon-button-color, inherit); }
