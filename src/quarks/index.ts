import { mergeProps, type ClassValue, type StyleValue } from '../props.js';
import { TemplateResult, nothing, type TemplateValue } from '../runtime.js';
...
/** A fragment-like Quark helper for grouping children without an element. */
