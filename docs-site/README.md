...
[Vue-to-Gluon cutover playbook](content/1.11.1/migration/vue-to-gluon-cutover/index.md).
...
The versioned
[codemod decision](content/1.11.1/migration/vue-codemod-decision/index.md)
