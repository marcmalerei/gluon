...
[Vue-to-Gluon cutover playbook](content/1.12.0/migration/vue-to-gluon-cutover/index.md).
...
The versioned
[codemod decision](content/1.12.0/migration/vue-codemod-decision/index.md)
