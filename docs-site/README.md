...
snippet corpus. `api-examples.json` maps all 575 current symbol pages to reviewed
...
[Vue-to-Gluon cutover playbook](content/1.0.2/migration/vue-to-gluon-cutover/index.md).
...
The versioned
[codemod decision](content/1.0.2/migration/vue-codemod-decision/index.md)
