...
Review the [deployment reference](/gluon/1.12.2/reference/deployment/) before
...
the repository check. See the [analyzer guide](/gluon/1.12.2/migration/vue-analyzer/).
