...
compatibility runtime, or migration codemod in version `1.12.2`.
...
verification commands that match the released `1.12.2` line.
...
[Vue host](/gluon/1.12.2/examples/vue.html) or execute:
