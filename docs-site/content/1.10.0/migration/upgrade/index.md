...
`1.10.0`, and every official `@gluonjs/*` package and `create-gluon` ship at
...
current supported target is `1.10.0`; older versioned docs remain available in
...
Read the [support matrix](/gluon/1.10.0/reference/support-matrix/) before changing
...
official package with the same exact `1.10.0` target.
...
- [Diagnostic catalog](/gluon/1.10.0/reference/diagnostics/)
- [Support matrix](/gluon/1.10.0/reference/support-matrix/)
- [Release operations](/gluon/1.10.0/guides/releasing/)
- [Migration index](/gluon/1.10.0/migration/)
- [Package portal](/gluon/1.10.0/packages/)
