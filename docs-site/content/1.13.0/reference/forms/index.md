...
with the native form/application or use [`@gluonjs/json-forms`](/gluon/1.13.0/api/generated/packages/json-forms/src/).

See the [request-free form guide](/gluon/1.13.0/reference/forms/) for the full contract and
SSR/browser example.
