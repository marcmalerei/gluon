...
`1.11.1`, and every official `@gluonjs/*` package and `create-gluon` ship at
...
current supported target is `1.11.1`; older versioned docs remain available in
...
Read the [support matrix](/gluon/1.11.1/reference/support-matrix/) before changing
...
npm install --save-exact @gluonjs/core@1.11.1 @gluonjs/reactivity@1.11.1 @gluonjs/router@1.11.1 @gluonjs/store@1.11.1
npm ci
...
official package with the same exact `1.11.1` target.
...
npm ls --depth=0 @gluonjs/core @gluonjs/reactivity @gluonjs/router @gluonjs/store @gluonjs/ssr @gluonjs/i18n @gluonjs/vite @gluonjs/gluon-components-vite @gluonjs/test-utils @gluonjs/devtools @gluonjs/devtools-api @gluonjs/graph @gluonjs/language-server @gluonjs/vue-migration-analyzer @gluonjs/quarks @gluonjs/atoms @gluonjs/molecules @gluonjs/organisms @gluonjs/json-forms create-gluon
npm install --workspace ./apps/storefront --save-exact @gluonjs/core@1.11.1 @gluonjs/router@1.11.1 @gluonjs/store@1.11.1
npm install --workspace ./apps/server --save-exact @gluonjs/ssr@1.11.1 @gluonjs/router@1.11.1 @gluonjs/store@1.11.1
npm ci
...
- [Diagnostic catalog](/gluon/1.11.1/reference/diagnostics/)
- [Support matrix](/gluon/1.11.1/reference/support-matrix/)
- [Release operations](/gluon/1.11.1/guides/releasing/)
- [Migration index](/gluon/1.11.1/migration/)
- [Package portal](/gluon/1.11.1/packages/)
