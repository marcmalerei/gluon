...
Review the [deployment reference](/gluon/1.0.10/reference/deployment/) before
...
the repository check. See the [analyzer guide](/gluon/1.0.10/migration/vue-analyzer/).
