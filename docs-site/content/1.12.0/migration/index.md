...
compatibility runtime, or migration codemod in version `1.12.0`.
...
verification commands that match the released `1.12.0` line.
...
[Vue host](/gluon/1.12.0/examples/vue.html) or execute:
