...
Review the [deployment reference](/gluon/1.12.0/reference/deployment/) before
...
the repository check. See the [analyzer guide](/gluon/1.12.0/migration/vue-analyzer/).
