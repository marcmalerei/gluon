import { css, defineAtom, defineGluonElement, elementEvent, elementProperty, html, type TemplateResult } from '@gluonjs/core';
...
export const ProductPicker = defineGluonElement({
