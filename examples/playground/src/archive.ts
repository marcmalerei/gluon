...
export function createStarterTar(project: PlaygroundProject): Blob {
  const manifest = `${JSON.stringify({
    ...
    dependencies: { '@gluonjs/core': '1.0.10', '@gluonjs/reactivity': '1.0.10' },
    devDependencies: { '@gluonjs/language-server': '1.0.10', '@gluonjs/vite': '1.0.10', typescript: '^5.7.0', vite: '^8.1.4' },
  }, null, 2)}\n`;
  const files = new Map([
