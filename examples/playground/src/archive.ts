...
export function createStarterTar(project: PlaygroundProject): Blob {
  const manifest = `${JSON.stringify({
    ...
    dependencies: { '@gluonjs/core': '1.11.2', '@gluonjs/reactivity': '1.11.2' },
    devDependencies: { '@gluonjs/language-server': '1.11.2', '@gluonjs/vite': '1.11.2', typescript: '^5.7.0', vite: '^8.2.1' },
  }, null, 2)}\n`;
  const files = new Map([
