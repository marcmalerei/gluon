...
export function createStarterTar(project: PlaygroundProject): Blob {
  const manifest = `${JSON.stringify({
    ...
    dependencies: { '@gluonjs/core': '1.11.1', '@gluonjs/reactivity': '1.11.1' },
    devDependencies: { '@gluonjs/language-server': '1.11.1', '@gluonjs/vite': '1.11.1', typescript: '^5.7.0', vite: '^8.2.1' },
  }, null, 2)}\n`;
  const files = new Map([
