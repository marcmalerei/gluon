...
| Cross-engine CI and bundle budgets | Acceptance infrastructure only; no customer-facing control belongs in the shop | Full GLUON GOODS browser suite in Playwright Chromium, Firefox, and WebKit + production HTML/JavaScript/image byte budgets | Integrated as release-quality evidence |
