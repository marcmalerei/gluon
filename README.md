...
> [!IMPORTANT]
> This source tree and package describe Gluon `1.8.1` across all 21 official
...
[step-by-step learning path](docs-site/content/1.8.1/guides/learning-path/index.md).
Before extracting shop UI, use the
[component decision guide](docs-site/content/1.8.1/guides/component-decisions/index.md):
...
[component guide](docs-site/content/1.8.1/guides/components/index.md) shows the
