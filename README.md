...
> [!IMPORTANT]
> This source tree and package describe Gluon `1.12.0` across all 21 official
...
- a tested, reversible [Vue-to-Gluon cutover playbook](docs-site/content/1.12.0/migration/vue-to-gluon-cutover/index.md)
- a versioned [Gluon upgrade guide](docs-site/content/1.12.0/migration/upgrade/index.md)
...
[step-by-step learning path](docs-site/content/1.12.0/guides/learning-path/index.md).
Before extracting shop UI, use the
[component decision guide](docs-site/content/1.12.0/guides/component-decisions/index.md):
...
[component guide](docs-site/content/1.12.0/guides/components/index.md) shows the
...
- [Gluon upgrade guide](docs-site/content/1.12.0/migration/upgrade/index.md)
...
Gluon 1.12.0 ships three documentation states:
