...
> [!IMPORTANT]
> This source tree and package describe Gluon `1.2.0` across all 17 official
...
- a tested, reversible [Vue-to-Gluon cutover playbook](docs-site/content/1.2.0/migration/vue-to-gluon-cutover/index.md)
...
[component guide](docs-site/content/1.2.0/guides/components/index.md) shows the
